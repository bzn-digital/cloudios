...
namespace Bzn.Cloudios.Infrastructure.Migrations
{
    ...
    [Migration("20260629172607_UpdateUserEmailUniqueConstraint")]
    partial class UpdateUserEmailUniqueConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bzn.Cloudios.Domain.Entities.Realm", b =>
                {
                    ...
                    b.Property<int?>("MaxManagedApps")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("MaxRamBytes")
                        .HasColumnType("INTEGER");
