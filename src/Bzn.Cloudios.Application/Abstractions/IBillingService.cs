...
public interface IBillingService
{
    ...
    Task RegisterDatabaseStartAsync(Guid managedDatabaseId, DateTime startedAtUtc, CancellationToken ct = default);
    Task RegisterDatabaseStopAsync(Guid managedDatabaseId, DateTime stoppedAtUtc, CancellationToken ct = default);
